...
for THRESHOLD in THRESHOLDs:
    ...
    with tqdm(total = df_sub.shape[0]) as pbar:
        for index, row in df_sub.iterrows():
            ...
            if((block_start_idx > -1) & (is_block==0) & (df_sub.loc[current_idx:current_idx+1,'xmin'].sum()==0) & (current_vid == previous_vid)):
    ...
    df_sub.to_csv('yolov2_fish_thres_max_all_class_{}.csv'.format(THRESHOLD))
